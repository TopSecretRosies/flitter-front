      ...
      <div class="row">
        <div class="col-12 col-sm-11 offset-sm-1 col-md-9 offset-md-1 col-lg-8 offset-lg-2 ">
          <form @submit.prevent="savePost()">
            <input @change="handleImage" class="form-control shadow-none p-3 mb-5 bg-light rounded w-100" type="file"
              name="image" id="formFile" />
            <div>
              <textarea v-model.lazy="text" class="form-control shadow-none bg-light rounded w-100" id="text" rows="6"
                maxlength="256" placeholder="Introduce un texto máximo 256 caracteres"></textarea>
            </div>
          ...
          <div class="cardbox shadow-lg bg-white" v-for="post in getUser.postList" :key="post.id" :post="post">
            <div class="cardbox-heading">
              ...
              <div class="media m-0">
                <div class="d-flex mr-3">
                  <a href=""><img class="img-fluid rounded-circle" :src="getUser.user?.avatar" alt="User" /></a>
                </div>
                <i class="fas fa-check-circle " style="color:darkblue"></i>
                <div class="media-body">
                  <p class="m-0" style="color:black;">{{ post.author[0].username }}</p>
                  <small><span><i class="icon ion-md-time"></i>{{ formatDate(post.createdAt) }}</span></small>
                </div>
              </div>
              <!--/ media -->
            </div>
            ...
            <div class="cardbox-comments">
              <span class="comment-avatar float-left">
                <a href=""><img class="rounded-circle" :src="getUser.user?.avatar" alt="..." /></a>
              </span>
              <div class="search">
